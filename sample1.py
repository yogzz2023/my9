...
for i in range(2, len(measurements)):
    ...
    time_steps.append(predicted_time)

# Plotting predicted values against time
plt.figure(figsize=(12, 8))

plt.subplot(3, 1, 1)
plt.plot(time_steps, predicted_range, label='Predicted Range')
plt.xlabel('Time')
plt.ylabel('Range')
plt.legend()

plt.subplot(3, 1, 2)
plt.plot(time_steps, predicted_azimuth, label='Predicted Azimuth')
plt.xlabel('Time')
plt.ylabel('Azimuth')
plt.legend()

plt.subplot(3, 1, 3)
plt.plot(time_steps, predicted_elevation, label='Predicted Elevation')
plt.xlabel('Time')
